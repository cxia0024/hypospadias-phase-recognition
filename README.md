...
![Stage 2 pipeline overview](docs/pipeline_diagram.svg)
...
The diagram above is generated by `scripts/generate_pipeline_diagram.py`;
regenerate it (`python3 scripts/generate_pipeline_diagram.py`) if the
notebook's pipeline structure changes.
